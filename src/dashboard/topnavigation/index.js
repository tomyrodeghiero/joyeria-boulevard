import { JOYERIA_BOULEVARD_LOGOTYPE_ICON } from "@/utils/constants";
  ...
  return (
    <header className="bg-white h-16 items-center relative shadow w-full z-10 md:h-20 lg:rounded-2xl">
      <div className="flex flex-center flex-col h-full justify-center mx-auto px-3 relative">
        <div className="flex items-center pl-1 relative w-full sm:pr-2 sm:ml-0 ">
          ...
          <div className="w-full">
            <div className="flex justify-end">
              <img
                alt="Joyería Boulevard Logotype"
                src={JOYERIA_BOULEVARD_LOGOTYPE_ICON}
                className="h-10 border border-gray-300 object-cover rounded-full w-10"
              />
            </div>
          </div>
        </div>
